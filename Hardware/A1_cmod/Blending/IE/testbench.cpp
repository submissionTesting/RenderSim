...
public:
    ...
    Connections::Combinational<VRU_IN_INT_TYPE> VRUInput;
    Connections::Combinational<VRU_OUT_INT_TYPE> VRUOutput;
    Connections::Combinational<INT12_TYPE> alpha0;
    Connections::Combinational<INT12_TYPE> alpha1;
    Connections::Combinational<INT12_TYPE> alpha2;
    Connections::Combinational<INT12_TYPE> alpha3;
    ...
    INT12_TYPE compute_expected_alpha(INT12_TYPE pixel_x, INT12_TYPE pixel_y, 
                                INT12_TYPE mean_x, INT12_TYPE mean_y,
                                INT12_TYPE conx, INT12_TYPE cony, INT12_TYPE conz,
                                INT12_TYPE opacity) {
    ...
    void run() {
        ...
        alpha0.Push(FP16_TYPE(0.1));
        alpha1.Push(FP16_TYPE(0.2));
        alpha2.Push(FP16_TYPE(0.3));
        alpha3.Push(FP16_TYPE(0.4));
        wait(5);
    ...
    void collect() {
        ...
        for (int i = 0; i < 3; i++) {
            VRU_OUT_INT_TYPE result;
            result = VRUOutput.Pop();
            
            INT8_TYPE r = result.color.r;
            INT8_TYPE g = result.color.g;
            INT8_TYPE b = result.color.b;
            
            cout << "\nResult for Test Case " << i+1 << ": " << endl;
            cout << "  Actual Color: (" << std::setprecision(6) << r << ", " 
                                        << std::setprecision(6) << g << ", " 
                                        << std::setprecision(6) << b << ")" << endl;
        }
