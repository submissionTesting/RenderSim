#define NVHLS_VERIFY_BLOCKS (VRU_v3)
#include "VRU.h"
...
public:
    ...
    void collect() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            double r = result.color.r.to_double();
            double g = result.color.g.to_double();
            double b = result.color.b.to_double();
