...
#### CullingConversionUnit (`A1_cmod/Sample/CullingConversionUnit`)
<a id="hamat"></a>
#### HAMAT (`A1_cmod/Sample/HAMAT`)
...
<a id="frm"></a>
#### FRM – Feed‑Forward Read Mapper (`A1_cmod/Encode/FRM`)
...
<a id="bum"></a>
#### BUM – Back‑Propagation Update Merger (`A1_cmod/Encode/BUM`)
<a id="ag"></a>
#### AG – Address/VID Generator (`A1_cmod/Encode/AG`)
...
<a id="igu"></a>
#### IGU – Index Generation Unit (`A1_cmod/Encode/IGU`)
...
<a id="icu"></a>
#### ICU – Index Computation Unit (`A1_cmod/Encode/ICU`)
...
<a id="dcu"></a>
#### DCU – Distance Compute Unit (`A1_cmod/Encode/DCU`)
...
<a id="cu"></a>
#### CU – Comparison Unit (`A1_cmod/Encode/CU`)
...
<a id="spe"></a>
#### SPE – Sensitivity Prediction Engine (`A1_cmod/Encode/SPE`)
...
<a id="peu"></a>
#### PEU – Position Encoding Unit (`A1_cmod/Encode/PEU`)
...
<a id="reducer"></a>
#### Reducer / Tree Reducer (`A1_cmod/Encode/reducer`)
...
<a id="mlp-vanilla"></a>
#### MLP_vanilla (`A1_cmod/FieldComp/MLP_vanilla`)
...
<a id="mlp-sonb"></a>
#### MLP_sonb (`A1_cmod/FieldComp/MLP_sonb`)
...
<a id="mlp-block"></a>
#### MLP_block (`A1_cmod/FieldComp/MLP_block`)
...
<a id="pe-array"></a>
#### PE_array (`A1_cmod/FieldComp/PE_array`)
...
#### fixedpoint_mul (`A1_cmod/FieldComp/fixedpoint_mul`)
...
<a id="adder-tree"></a>
#### Adder Tree / Reduction Core (generic)
...
<a id="bsu"></a>
#### BSU – Bitonic Sort Unit (`A1_cmod/Blending/BSU`)
...
<a id="qsu"></a>
#### QSU – Quick Sort Unit (`A1_cmod/Blending/QSU`)
...
<a id="tilemerging"></a>
#### TileMerging (`A1_cmod/Blending/TileMerging`)
...
#### FeatureCompute (VRU stage) (`A1_cmod/Blending/FeatureCompute`)
<a id="vru_v1"></a>
#### VRU variant 1 (`A1_cmod/Blending/VRU_v1`)
...
<a id="vru_v2"></a>
#### VRU variant 2 (`A1_cmod/Blending/VRU_v2`)
...
<a id="vru_v3"></a>
#### VRU variant 3 (`A1_cmod/Blending/VRU_v3`)
...
<a id="vru_v4"></a>
#### VRU variant 4 (`A1_cmod/Blending/VRU_v4`)
...
#### GradientCompute (`A1_cmod/Blending/GradientCompute`)
...
#### GradientPruning (`A1_cmod/Blending/GradientPruning`)
...
#### Rearrangement (RU) (`A1_cmod/Blending/Rearrangement`)
...
#### RowProcessing (GBU Row PE) (`A1_cmod/Blending/RowProcessing`)
...
#### RowGeneration (`A1_cmod/Blending/RowGeneration`)
...
#### DecompBinning (`A1_cmod/Blending/DecompBinning`)
<a id="pe-arrays"></a>
#### PE Arrays (Tile/Row PE replication)
...
<a id="ie"></a>
#### IE – Interpolation Engine (`A1_cmod/Blending/IE`)
...
<a id="uniie"></a>
#### UNIIE – Unified Nonlinear Interpolation Engine (`A1_cmod/Blending/UNIIE`)
